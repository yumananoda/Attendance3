...
/**
 * Servlet implementation class HolidayStatusApprovedServlet
 */
@WebServlet("/HolidayStatusApprovedServlet")
public class HolidayStatusApprovedServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public HolidayStatusApprovedServlet() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		System.out.println("called statusApproved");
